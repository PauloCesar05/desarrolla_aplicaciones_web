                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                            ...
                            <td>
                                <a href="actualizarRegistro.php<?php echo $row[$id]; ?>" class="btn btn-primary">Editar</a>
                                <a href="eliminarRegistro.php<?php echo $row[$id]; ?>" class="btn btn-danger">Eliminar</a>
                            </td>
                        </tr>
                      <?php 
                      } 
